<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Mdashboard extends CI_Model{
		...
		function get_data_diagnosa_ird($tgl_awal, $tgl_akhir){
			return $this->db->query("SELECT nm_diagnosa as nama, SUM(jumlah) AS jumlah FROM data_diagnosa_ird WHERE tgl_kunjungan>='$tgl_awal' AND tgl_kunjungan<='$tgl_akhir' and id_diagnosa is not NULL and id_diagnosa!='' GROUP BY id_diagnosa ORDER BY jumlah DESC");
		}

		function get_data_diagnosa_irj($tgl_awal, $tgl_akhir){
			return $this->db->query("SELECT nm_diagnosa as nama, SUM(jumlah) AS jumlah FROM data_diagnosa_irj WHERE tgl_kunjungan>='$tgl_awal' AND tgl_kunjungan<='$tgl_akhir' and id_diagnosa is not NULL and id_diagnosa!='' GROUP BY id_diagnosa ORDER BY jumlah DESC");
		}

		function get_data_diagnosa_iri($tgl_awal, $tgl_akhir){
			return $this->db->query("SELECT nm_diagnosa as nama, SUM(jumlah) AS jumlah FROM data_diagnosa_iri WHERE tgl_kunjungan>='$tgl_awal' AND tgl_kunjungan<='$tgl_akhir' and id_diagnosa is not NULL and id_diagnosa!=''GROUP BY id_diagnosa ORDER BY jumlah DESC LIMIT");
		}

		function get_excel_diagnosa_ird($tgl_awal, $tgl_akhir){
			return $this->db->query("SELECT id_diagnosa as id, nm_diagnosa as nama, SUM(jumlah) AS jumlah FROM data_diagnosa_ird WHERE tgl_kunjungan>='$tgl_awal' AND tgl_kunjungan<='$tgl_akhir' and id_diagnosa is not NULL and id_diagnosa!='' GROUP BY id_diagnosa ORDER BY jumlah DESC LIMIT 0, 10");
		}

		function get_excel_diagnosa_irj($tgl_awal, $tgl_akhir){
			return $this->db->query("SELECT id_diagnosa as id, nm_diagnosa as nama, SUM(jumlah) AS jumlah FROM data_diagnosa_irj WHERE tgl_kunjungan>='$tgl_awal' AND tgl_kunjungan<='$tgl_akhir' and id_diagnosa is not NULL and id_diagnosa!='' GROUP BY id_diagnosa ORDER BY jumlah DESC LIMIT 0, 10");
		}

		function get_excel_diagnosa_iri($tgl_awal, $tgl_akhir){
			return $this->db->query("SELECT id_diagnosa as id, nm_diagnosa as nama, SUM(jumlah) AS jumlah FROM data_diagnosa_iri WHERE tgl_kunjungan>='$tgl_awal' AND tgl_kunjungan<='$tgl_akhir' and id_diagnosa is not NULL and id_diagnosa!='' GROUP BY id_diagnosa ORDER BY jumlah DESC LIMIT 0, 10");
		}
