		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-primary">
					...
					<div class="box-body">
						<br>
							<form id="idform" method="POST" role="form">
								...
								<div class="form-group row">
									<p class="col-lg-3 form-control-label">E-mail *</p>
									<div class="col-lg-6">
										<input type="email" class="form-control" placeholder="" id="email" name="email" required>
									</div>
								</div>
								<div class="form-group row">
									<p class="col-lg-3 form-control-label">Role *</p>
									<div class="col-lg-6">
...
<!-- 							<div class="input-group">
								...
								<div class="form-group row">
									<p class="col-lg-3 form-control-label"></p>
									<div class="col-lg-6">
										<div class="form-inline">
											<button type="reset" class="btn btn-danger"><i class="fa fa-eraser"></i> Reset</button>
											<button class="btn btn-primary" type="submit" id="btn-save"><i class="fa fa-paper-plane"></i>Simpan</button>
...
$(function() {
	...
	$('#idform').on('submit', function(e){       
         $("#btn-save").prop('disabled', true).css('cursor','wait').html('<i class="fa fa-spinner fa-spin" ></i> Menyimpan User Baru...');
         $.ajax({    
           ...
           success: function(result) {
             console.log(result);
             $("#btn-save").prop('disabled', false).css('cursor','pointer').html('<i class="fa fa-paper-plane"></i> KIRIM DATA USER'); 
             swal("Sukses","Data USER Berhasil Disimpan.", "success"); 
             location.reload(); 
           },
           error:function(event, textStatus, errorThrown) {
             $("#btn-save").prop('disabled', false).css('cursor','pointer').html('<i class="fa fa-paper-plane"></i> KIRIM DATA USER');
             swal("Gagal Menyimpan Data USER!",formatErrorMessage(event, errorThrown), "error"); 
           }  
         }); 
         e.preventDefault();          
     });
		...
		columns: [
			{ data: "id" },
			{
				...
				render: function ( data, type, row ) {
					if ( type === 'display' ) {
						if (data==0){
							return "<input type='radio' name='checkApp' value='"+vid+"' onchange='chooseApp(this)'/>";
						}else{
							return "<input type='radio' name='checkApp' value='"+vid+"' onchange='chooseApp(this)' checked/>";
						}
					}
					return data;
				},
