  ...
  <div class="small-box" style="background: #e4efe0">
    <div class="inner">
      <div class="container-fluid text-center" style="padding: 15px;">
        <?php echo form_open('C_pasienppi/search');?>
          <div class="form-inline">               
            ...
            <!--auto_search_by_nocm-->
            <input type="search" maxlength="10" class="auto_search_by_nocm form-control" id="cari_no_cm" name="cari_no_cm" placeholder="Pencarian No CM">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border text-center">
          <h4 class="box-title text-bold">DAFTAR PASIEN</h4>
        </div>
        <div class="box-body">
              ...
              ?>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="<?php echo site_url('c_pasienppi/kirim/'.$row->NO_REGISTER.'/'.$row->IDRG); ?>" class="btn btn-primary btn-block btn-xs">Proses Data PPI</a>
                  </td>
                </tr>
              <?php } 
                }
